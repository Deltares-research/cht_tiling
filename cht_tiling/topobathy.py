    ...
    for i in range(ix0, ix1 + 1):
        ...
        if parallel:
            ...
            for j in range(iy0, iy1 + 1):
                ...
                create_highest_zoom_level_tile(zoom_path_i, i, j, izoom, twm, data_list, options)
...
def create_highest_zoom_level_tile(zoom_path_i, i, j, izoom, twm, data_list, options):
