"""Generate a self-contained Leaflet HTML viewer for browsing tiled map layers."""
...
def write_html(
    file_name: str,
    title: str = "CHT Tiling",
    legend_title: str = "Legend",
    max_native_zoom: int = 19,
) -> None:
    """Write a standalone Leaflet-based HTML file that displays tiled map data.

    The generated page includes OpenStreetMap and Esri World Imagery base layers
    with a local tile overlay loaded from a ``{z}/{x}/{y}.png`` URL pattern.
    ...
    title : str
        Page heading shown above the map.
    legend_title : str
        Text displayed inside the legend box.
    max_native_zoom : int
        Maximum native zoom level of the data tile layer.
    """
